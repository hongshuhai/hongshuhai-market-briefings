...
这是 Frank 在 2026 年做期货经纪业务时沉淀的**两个日常自动化项目**，经过 8 月份多轮迭代稳定下来后开源：
...
**核心理念**：报告不是给自己看的，而是给**客户群**用的——每一份报告都要能让读者直接行动。所以我们做了 L1→L2→L3 三层升级：分析层（说了什么）→ 咨询层（关键问题拆解）→ 行动层（具体动作 + 量化参数）。
